...
class Skin_Simple extends Skin_Base {
	...
	public function __construct( Widget_Base $parent ) {
		// define parent widget (posts)
		$this->parent = $parent;

		add_filter( 'elementor/widget/print_template', array( $this, 'skin_print_template' ), 10, 2 );
		add_action( 'elementor/element/posts/section_layout/before_section_end', [ $this, 'add_controls' ] );
		add_action( 'elementor/element/posts/section_query/after_section_end', [ $this, 'update_controls' ] );
	}
	...
	public function add_controls( Widget_Base $widget ) {
		$this->parent = $widget;
	...
	<<?php echo $tag; ?> class="elementor-post__title">
			<span class="short-pretitle"><?php echo get_post_meta(get_the_ID(), 'Short PreTitle',true); ?></span>
				<?php echo get_post_meta(get_the_ID(), 'Short Title',true); ?>
